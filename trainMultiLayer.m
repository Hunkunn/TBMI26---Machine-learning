...
for n = 1:numIterations
    ...
    grad_v = 2*UTrain'*(YTrain - DTrain)/NTrain; % Gradient for the output layer
    grad_w = 2*XTrain'*(((YTrain - DTrain)*Vout(1:end-1,:)').*tanhprim(UTrain(:,1:end-1)))/NTrain; % And the input layer
